...
//db.run("UPDATE users SET admin = (?) WHERE id = 1", [true]);
...
//db.run("INSERT INTO users(email,password,country,admin,username) VALUES (?,?,?,?,?)");
//db.run("INSERT INTO verification(code,gültig) VALUES (?,?)", ["admin",true]);